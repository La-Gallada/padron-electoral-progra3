...
"C:\\Users\\wdtai\\Downloads\\padron_completo\\PADRON_COMPLETO.txt"; /// Cambien esto por su RUTA origen para que le sirve
    ...
    private void initComponents() {
        ...
        TX3.addActionListener(this::TX3ActionPerformed);
        ...
        jLabel5.setText("Buscar por nombre y area");
 ...
 new Thread(() -> {
    ...
    RepositorioPadronTxt repo = new RepositorioPadronTxt();
    RepositorioDistelecTxt repoDir = new RepositorioDistelecTxt();

    repoDir.cargar();

    String nombre = TX2.getText();
    String lugar = TX3.getText();

    repo.buscarPorNombreYLugar(nombre, lugar, repoDir, txtArea);
 ...
 new Thread(() -> {
    ...
    String cedula = TX1.getText();

    String resultado = repo.buscarPorCedula(cedula);
...
new Thread(() -> {
    ...
    String nombre = TX4.getText();

    repo.buscarPorNombre(nombre, repoDir, txtArea);
